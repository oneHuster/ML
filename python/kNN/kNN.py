...
def datingClassTest():#cross-validation
...
def classifyPerson():
	...
	percentTats = float(raw_input("percentage of time spent playing vidoe games"))

	ffMiles = float(raw_input("freguent flier miles earned per year?"))
	iceCream = float(raw_input("liters of ice cream consumed per year?"))
	date,labels = file2matrix('datingTestSet2.txt')
